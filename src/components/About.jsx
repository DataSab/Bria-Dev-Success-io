      ...
      <div className="container">
        ...
        <div ref={titleRef} style={titleStyle} className="row justify-content-center mb-4">
          <div className="col-md-12 text-center">
            ...
            <div style={{ width: '50px', height: '4px', background: '#FFA500', margin: '0 auto' }}></div>
          </div>
        </div>
                ...
                <ul style={{ listStyle: 'none', padding: 0, margin: 0 }}>
                  {[1, 2, 3].map((num) => (
                    <li key={num} style={{
                      ...
                      <span aria-hidden="true" style={{ color: '#FFA500', marginRight: '10px', fontWeight: '900', marginTop: '2px' }}>✓</span>
                      {t(`about.goal.${num}`)}
                    </li>
                  ))}
                </ul>
