    ...
    <section id="contact-section" style={{
      ...
      <div className="contact-inner" style={{
        ...
        <div className="icon" style={{ 
          width: '80px',
          height: '80px',
          background: 'linear-gradient(135deg, #FFA500 0%, #ffd662 100%)',
          borderRadius: '50%',
          fontSize: '30px', 
          color: '#fff',
        ...
        <div className="d-flex justify-content-center">
          <a 
            ...
            onMouseOver={(e) => {
              ...
              e.currentTarget.style.boxShadow = '0 12px 25px rgba(255, 165, 0, 0.4)';
            }}
            onMouseOut={(e) => {
              e.currentTarget.style.transform = 'translateY(0)';
              e.currentTarget.style.boxShadow = '0 8px 25px rgba(255, 165, 0, 0.3)';
            }}
          >
