            ...
            {categories.map(cat => (
              <button
                ...
                style={{
                  ...
                  background: filter === cat ? '#FFA500' : 'rgba(255, 165, 0, 0.1)',
                  color: filter === cat ? '#000' : '#FFA500',
                  fontWeight: '700',
                  cursor: 'pointer',
          ...
          {filteredEvents.map((event, index) => (
            <div
              ...
              onMouseOver={(e) => {
                ...
                e.currentTarget.style.boxShadow = '0 25px 50px rgba(255, 165, 0, 0.3)';
                e.currentTarget.style.borderColor = '#FFA500';
              }}
              onMouseOut={(e) => {
        ...
        <div style={{
          ...
          <a
            ...
            onMouseOver={(e) => {
              ...
              e.currentTarget.style.boxShadow = '0 10px 30px rgba(255, 165, 0, 0.5)';
            }}
            onMouseOut={(e) => {
              e.currentTarget.style.transform = 'translateY(0)';
              e.currentTarget.style.boxShadow = '0 5px 20px rgba(255, 165, 0, 0.4)';
            }}
          >
            Me contacter
          </a>
